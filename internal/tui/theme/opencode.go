...
// ellieCodeTheme implements the Theme interface with ellieCode brand colors.
// It provides both dark and light variants.
type ellieCodeTheme struct {
	BaseTheme
}

// NewellieCodeTheme creates a new instance of the ellieCode theme.
func NewellieCodeTheme() *ellieCodeTheme {
	// ellieCode color palette
	// Dark mode colors
